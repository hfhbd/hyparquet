...
export const ParquetType: string[] = [
  'BOOLEAN',
  'INT32',
  'INT64',
  'INT96', // deprecated
...
export const FieldRepetitionType: string[] = [
  'REQUIRED',
  'OPTIONAL',
  'REPEATED',
]
...
export const ConvertedType: string[] = [
  'UTF8',
  'MAP',
  'MAP_KEY_VALUE',
  'LIST',
...
export const CompressionCodec: string[] = [
  'UNCOMPRESSED',
  'SNAPPY',
  'GZIP',
  'LZO',
...
export const BoundaryOrder: string[] = [
  'UNORDERED',
  'ASCENDING',
  'DESCENDING',
]
...
export const EdgeInterpolationAlgorithm: string[] = [
  'SPHERICAL',
  'VINCENTY',
  'THOMAS',
  'ANDOYER',
