...
describe('Parquet schema utils', () => {
  const schema: SchemaElement[] = [
    { name: 'root', num_children: 7, repetition_type: undefined, logical_type: undefined },
    { name: 'flat', repetition_type: FieldRepetitionType.OPTIONAL, logical_type: undefined },
    { name: 'listy', repetition_type: FieldRepetitionType.OPTIONAL, num_children: 1, converted_type: ConvertedType.LIST, logical_type: undefined },
    { name: 'list', repetition_type: FieldRepetitionType.REPEATED, num_children: 1, logical_type: undefined },
    { name: 'element', repetition_type: FieldRepetitionType.REQUIRED, logical_type: undefined },
    { name: 'mappy', repetition_type: FieldRepetitionType.OPTIONAL, num_children: 1, converted_type: ConvertedType.MAP, logical_type: undefined },
    { name: 'map', repetition_type: FieldRepetitionType.REPEATED, num_children: 2, logical_type: undefined },
    { name: 'key', repetition_type: FieldRepetitionType.REQUIRED, logical_type: undefined },
    { name: 'value', repetition_type: FieldRepetitionType.OPTIONAL, logical_type: undefined },
    { name: 'invalid_list', repetition_type: FieldRepetitionType.OPTIONAL, num_children: 2, converted_type: ConvertedType.LIST, logical_type: undefined },
    { name: 'list1', repetition_type: FieldRepetitionType.REPEATED, logical_type: undefined },
    { name: 'list2', repetition_type: FieldRepetitionType.REPEATED, logical_type: undefined },
    { name: 'structy', repetition_type: FieldRepetitionType.OPTIONAL, num_children: 2, converted_type: ConvertedType.LIST, logical_type: undefined },
    { name: 'element1', repetition_type: FieldRepetitionType.REQUIRED, logical_type: undefined },
    { name: 'element2', repetition_type: FieldRepetitionType.REQUIRED, logical_type: undefined },
    { name: 'list_structy', repetition_type: FieldRepetitionType.OPTIONAL, num_children: 1, converted_type: ConvertedType.LIST, logical_type: undefined },
    { name: 'list', repetition_type: FieldRepetitionType.REPEATED, num_children: 2, logical_type: undefined },
    { name: 'element1', repetition_type: FieldRepetitionType.REQUIRED, logical_type: undefined },
    { name: 'element2', repetition_type: FieldRepetitionType.REQUIRED, logical_type: undefined },
    { name: 'invalid_list', repetition_type: FieldRepetitionType.OPTIONAL, num_children: 1, converted_type: ConvertedType.LIST, logical_type: undefined },
    { name: 'list', repetition_type: FieldRepetitionType.OPTIONAL, num_children: 1, logical_type: undefined },
    { name: 'element', repetition_type: FieldRepetitionType.OPTIONAL, logical_type: undefined },
  ]
