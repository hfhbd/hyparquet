...
import {ParquetType} from "../src/types.js";

describe('readPlain', () => {
  it('returns empty array for count 0', () => {
    const view = new DataView(new ArrayBuffer(4))
    const reader = { view, offset: 0 }
    const result = readPlain(reader, ParquetType.INT32, 0, undefined)
  ...
  it('reads BOOLEAN values', () => {
    ...
    const reader = { view, offset: 0 }
    const result = readPlain(reader, ParquetType.BOOLEAN, 3, undefined)
  ...
  it('reads INT32 values', () => {
    ...
    const reader = { view, offset: 0 }
    const result = readPlain(reader, ParquetType.INT32, 1, undefined)
  ...
  it('reads INT64 values', () => {
    ...
    const reader = { view, offset: 0 }
    const result = readPlain(reader, ParquetType.INT64, 1, undefined)
  ...
  it('reads INT96 values', () => {
    ...
    const reader = { view, offset: 0 }
    const result = readPlain(reader, ParquetType.INT96, 1, undefined)
  ...
  it('reads FLOAT values', () => {
    ...
    const reader = { view, offset: 0 }
    const result = readPlain(reader, ParquetType.FLOAT, 1, undefined)
  ...
  it('reads DOUBLE values', () => {
    ...
    const reader = { view, offset: 0 }
    const result = readPlain(reader, ParquetType.DOUBLE, 1, undefined)
  ...
  it('reads BYTE_ARRAY values', () => {
    ...
    view.setUint8(6, 3)
    const reader = { view, offset: 0 }
    const result = readPlain(reader, ParquetType.BYTE_ARRAY, 1, undefined)
  ...
  it('reads FIXED_LEN_BYTE_ARRAY values', () => {
    ...
    view.setUint8(3, 7)
    const reader = { view, offset: 0 }
    const result = readPlain(reader, ParquetType.FIXED_LEN_BYTE_ARRAY, 2, fixedLength)
  ...
  it('throws for missing fixedLength', () => {
    const view = new DataView(new ArrayBuffer(1))
    const reader = { view, offset: 0 }
    expect(() => readPlain(reader, ParquetType.FIXED_LEN_BYTE_ARRAY, 1, undefined))
  ...
  it('throws an error for unhandled types', () => {
    ...
    const reader = { view, offset: 0 }
    const invalidType: any = 'invalidType'
